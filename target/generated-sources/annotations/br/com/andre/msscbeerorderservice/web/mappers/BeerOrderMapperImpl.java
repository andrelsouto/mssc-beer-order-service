...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected br.com.andre.msscbeerorderservice.web.model.OrderStatusEnum orderStatusEnumToOrderStatusEnum(OrderStatusEnum orderStatusEnum) {
        if (orderStatusEnum == null) {
            return null;
        }

        br.com.andre.msscbeerorderservice.web.model.OrderStatusEnum orderStatusEnum1;

        switch (orderStatusEnum) {
            case NEW:
                orderStatusEnum1 = br.com.andre.msscbeerorderservice.web.model.OrderStatusEnum.NEW;
                break;
            case READY:
                orderStatusEnum1 = br.com.andre.msscbeerorderservice.web.model.OrderStatusEnum.READY;
                break;
            case PICKED_UP:
                orderStatusEnum1 = br.com.andre.msscbeerorderservice.web.model.OrderStatusEnum.PICKED_UP;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + orderStatusEnum);
        }
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum1(br.com.andre.msscbeerorderservice.web.model.OrderStatusEnum orderStatusEnum) {
        if (orderStatusEnum == null) {
            return null;
        }
        ...
        switch (orderStatusEnum) {
            case NEW:
                orderStatusEnum1 = OrderStatusEnum.NEW;
                break;
            case READY:
                orderStatusEnum1 = OrderStatusEnum.READY;
                break;
            case PICKED_UP:
                orderStatusEnum1 = OrderStatusEnum.PICKED_UP;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + orderStatusEnum);
        }
